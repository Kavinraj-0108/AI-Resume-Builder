           ...
           bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-colors'>
            ...
            {data.length === 0 ? (
                ...
                text-gray-300'/>
                    ...
                    <p className='text-sm'>Click "Add Education" to get
                        started.</p>
                </div>
            ) : (
                <div className='space-y-4'>
                 ...
                 space-y-3'>
                            <div className='flex justify-between items-start'>
                                <h4 className='text-md font-semibold text-gray-900'>Education #
                                    {index + 1}</h4>
                        ...
                        hover:text-red-700 transition-colors'>
                            ...
                            <div className='grid md:grid-cols-2 gap-3'>
                                <input value={education.institution || ""} onChange={(e) =>
                                    ...
                                    type="text" placeholder='Institution Name' className='px-3 py-2
                        text-sm '/>
                                ...
                                <input value={education.field || ""} onChange={(e) =>
                                    ...
                                    type="text" className='px-3 py-2 text-sm '
