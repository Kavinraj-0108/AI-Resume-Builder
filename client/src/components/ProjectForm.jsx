                ...
                {data.map((project, index) => (
                 ...
                 space-y-3'>
                        <div className='flex justify-between items-start'>
                            <h4 className='text-md font-semibold text-gray-900'>Project #
                                {index + 1}</h4>
                        ...
                        <div className='grid gap-3'>
                            <input value={project.name || ""} onChange={(e) =>
                                ...
                                type="text" placeholder='Project Name' className='px-3 py-2
                        text-sm rounded-lg border-gray-700'/>

                            <input value={project.type || ""} onChange={(e) =>
                                updateProject(index, "type", e.target.value)}
                                type="text" placeholder="Project Type (e.g., Web, Mobile)"
